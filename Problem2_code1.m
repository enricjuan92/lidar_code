...
for i=1:151
   ...
   p_r_raman(i) = (K/R_15km(i)^2)*(NR*RCross_section)*exp(-2 * (Alpha_aer*R_15km(i) + Alpha_mol_int*+Alpha_raman_aer* R_15km(i)+Alpha_raman_mol_int) );
end
